...
class Laporan_tahunanController extends Controller
{
	...
	public function actionIndex()
	{
		...
		$graph = Yii::app()->db->createCommand('SELECT SUBSTRING(a.created_at,1,4) as created, a.id_master_transaksi, a.total, b.member FROM `tbl_master_transaksi` a left join tbl_pasien b on a.id_pasien = b.id_pasien WHERE SUBSTRING(a.created_at,1,4) in ('.$in_date.') order by SUBSTRING(a.created_at,1,4) ASC')->queryAll();
