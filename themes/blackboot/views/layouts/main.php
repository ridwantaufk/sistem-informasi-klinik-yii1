				...
				<div class="nav-collapse">
					<?php $this->widget('zii.widgets.CMenu', array(
						...
						'items' => array(
							...
							array(
								'label' => '<i class="fa fa-cube"></i> Master Data <span class="caret"></span>', 'url' => '#', 'itemOptions' => array('class' => 'dropdown', 'tabindex' => "-1"), 'linkOptions' => array('class' => 'dropdown-toggle', 'data-toggle' => "dropdown"),
								'items' => array(
							...
							array(
								'label' => '<i class="fa fa-tags"></i> Transaksi <span class="caret"></span>', 'url' => '#', 'itemOptions' => array('class' => 'dropdown', 'tabindex' => "-1"), 'linkOptions' => array('class' => 'dropdown-toggle', 'data-toggle' => "dropdown"),
								'items' => array(
							...
							array(
								'label' => '<i class="fa fa-list"></i> Laporan <span class="caret"></span>', 'url' => '#', 'itemOptions' => array('class' => 'dropdown', 'tabindex' => "-1"), 'linkOptions' => array('class' => 'dropdown-toggle', 'data-toggle' => "dropdown"),
								'items' => array(
							...
							array(
								'label' => '<i class="fa fa-wrench"></i> Tools <span class="caret"></span>', 'url' => '#', 'itemOptions' => array('class' => 'dropdown', 'tabindex' => "-1"), 'linkOptions' => array('class' => 'dropdown-toggle', 'data-toggle' => "dropdown"),
								'items' => array(
		...
		<div class="container">
			<div class="row">
				<div id="footer-terms" class="col-md-12">
					© <?php echo date('Y'); ?> - <?php echo CHtml::encode($this->pageTitle); ?>. <a href="https://www.linkedin.com/in/ridwan-taufik-b3624325a/" target="_blank">RIdwan Taufik</a>.
				</div> <!-- /.span6 -->
			</div> <!-- /row -->
		</div> <!-- /container -->
	</div>
