					...
					<div class="dropdown-menu pull-right">
						<div class="right-details">
							...
							<ul>
								...
								<li>
									<a href="<?php echo Yii::app()->baseUrl; ?>/profile">Ubah Password</a>
								</li>
							</ul>
						</div>
					</div>
	...
	<div id="main">
		<div id="navigation" style="width:290px;">
			...
			<ul class="mainNav" data-open-subnavs="multi" style="width:280px;">
				<li class='active'>
					<a href="<?php echo Yii::app()->baseUrl; ?>/dashboard"><i class="icon-home icon-white"></i><span>Beranda</span></a>
				</li>
				...
				?>
					...
					<li class='active'>
						...
						<ul class="subnav">
							...
							<li>
								<a href="<?php echo Yii::app()->baseUrl; ?>/users"><i class="icon-user icon-white"></i><span> Data Pengguna</span></a>
							</li>
							<li>
